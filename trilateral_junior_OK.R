    ...
    
{
    ...
    setwd("E:/KEEP_ISKAR/R/datos/evaluaciones/desarrollotrilateral/datos")
    ...
    resultados_tabla <<- data.frame(nombres, mean_caracter_junior, mean_trabajo_junior, mean_relaciones_junior)
    nombre_columnas <- c("Trabajador", "Caracter", "Trabajo", "Relaciones")
    colnames(resultados_tabla) <- nombre_columnas
    as.factor(resultados_tabla["Trabajador"])
    resultados_tabla$Trabajador <- as.character(resultados_tabla$Trabajador)
    trilateral_junior_usuario <<- ddply(resultados_tabla, "Trabajador", summarise, 
    ...
    setwd("E:/KEEP_ISKAR/R/datos/evaluaciones/desarrollotrilateral/reportes")
    ...
    setwd("D:/KEEP_ISKAR/R/datos/evaluaciones/desarrollotrilateral/datos")
