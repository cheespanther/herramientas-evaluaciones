...

{
    ...
    setwd("E:/KEEP_ISKAR/R/datos/evaluaciones/calidadsr/datos")  
    ...
    survey_senior_lider <- survey_senior_columnas[6:9,]
    colnames(survey_senior_lider) <- nombres_senior
    
    survey_senior_tareas <- survey_senior_columnas[10:12,]
    colnames(survey_senior_tareas) <- nombres_senior
    
    survey_senior_trabajo <- survey_senior_columnas[13:15,]
    ...
    setwd("E:/KEEP_ISKAR/R/datos/evaluaciones/calidadsr/reportes")  
